...
#    $ end = Ending ()
    ...
    $he("Какие захватывающие подробности...")
    ...
    $fri("Не было такого сна, не поверишь!")
    ...
    $he("Эй-эй, послушай, это я фигурально выразился. Я вполне обойдусь без деталей.")
    ...
    $he("#(Как-то на меня накатило и я ему сдуру рассказал историю про меня и ----- и с тех пор у меня нет преданнее поклонника."
        "Но за это регулярно приходится проявлять сострадание и выслушивать истории кого и куда он планирует поставить.)")
...
# Ивент 2
    call bigletter(["{size=-7}НегоциантЪ 20.05.133{/size}\n\n{size=-7}Красота империи!!!{/size}\n\n"
